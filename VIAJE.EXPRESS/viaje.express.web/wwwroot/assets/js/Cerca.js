...
function guardarCerca() {
    ...
    fetch('https://apptaxis2.azurewebsites.net/Cerca', {
        ...
        $("#contenido").append($("<tr id='" + document.getElementById("nombre").value + "'>" +

            " <th scope=row>" + document.getElementById("nombre").value + "</th>" +
            ...
            "<td>" +
            "<button type='button' id='buscarChofer' value='" + document.getElementById("nombre").value + "' onclick='buscarCerca(this)'>Modificar</button>" + "</td > " +

            "<td>" +
            "<button type='button' id='eliminar' value='" + document.getElementById("nombre").value + "' onclick='eliminarC(this)'>Eliminar</button>" + "</td > " +
